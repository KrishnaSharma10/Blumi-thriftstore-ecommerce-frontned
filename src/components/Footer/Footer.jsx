            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap">
                    <div className="w-full md:w-1/4 px-4 mb-8 md:mb-0">
                        <h4 className="text-lg font-medium text-white capitalize mb-8 relative before:content-[''] before:absolute before:left-0 before:bottom-[-10px] before:w-12 before:h-0.5 before:bg-blue-500">Company</h4>
                    ...
                    <div className="w-full md:w-1/4 px-4 mb-8 md:mb-0">
                        <h4 className="text-lg font-medium text-white capitalize mb-8 relative before:content-[''] before:absolute before:left-0 before:bottom-[-10px] before:w-12 before:h-0.5 before:bg-blue-500">Need Help?</h4>
                        <ul className="list-none">
                    ...
                    <div className="w-full md:w-1/4 px-4 mb-8 md:mb-0">
                        <h4 className="text-lg font-medium text-white capitalize mb-8 relative before:content-[''] before:absolute before:left-0 before:bottom-[-10px] before:w-12 before:h-0.5 before:bg-blue-500">Services</h4>
                        <ul className="list-none">
                    ...
                    <div className="w-full md:w-1/4 px-4 mb-8 md:mb-0">
                        <h4 className="text-lg font-medium text-white capitalize mb-8 relative before:content-[''] before:absolute before:left-0 before:bottom-[-10px] before:w-12 before:h-0.5 before:bg-blue-500">Contact us</h4>
